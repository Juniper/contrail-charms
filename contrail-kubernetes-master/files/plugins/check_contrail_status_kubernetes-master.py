...
def check_contrail_status(services):
    ...
    try:
        output = subprocess.check_output("export CONTRAIL_STATUS_CONTAINER_NAME=contrail-status-kubernetes-master-nrpe ; sudo contrail-status", shell=True).decode('UTF-8')
